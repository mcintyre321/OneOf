...
";
        ...
        [Fact]
        public void GenerateClassWithGenericType()
        {
            const string input = @"
using OneOf;
...
{
    [GenerateOneOf]
    public partial class ObjectOrNumber<T> : OneOfBase<T, int> { }
}
";
            const string expectedCode = @"// <auto-generated />
#pragma warning disable 1591
...
namespace Foo
{
    partial class ObjectOrNumber<T>
    {
        public ObjectOrNumber(OneOf.OneOf<T, int> _) : base(_) { }

        public static implicit operator ObjectOrNumber<T>(T _) => new ObjectOrNumber<T>(_);
        public static explicit operator T(ObjectOrNumber<T> _) => _.AsT0;

        public static implicit operator ObjectOrNumber<T>(int _) => new ObjectOrNumber<T>(_);
        public static explicit operator int(ObjectOrNumber<T> _) => _.AsT1;
    }
}
";
  
            AssertCorrectSourceCodeIsGeneratedWithNoDiagnostics(input, expectedCode, "Foo_ObjectOrNumber.g.cs");
        }
